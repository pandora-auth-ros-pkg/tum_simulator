...
private:
    ...
    // ardrone autonomy published topics
    ...
    // Vision speed simulation model
    SensorModel3 speedModel;
    ...
    std::string imu_plugin_topic_;
    std::string mag_plugin_topic_;
    std::string sonar_plugin_topic_;
